...
|---|---|---|---|
| _Nessun branch in review_ | — | — | Ultime mergeate: PR #20 (perf audit, fra1 + caching + Suspense + over-fetching fix), PR #19 (cutover Supabase, ri-mergeata dopo revert + travaso dati). |
