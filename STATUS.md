...
|---|---|---|---|
| _Nessun branch in review_ | — | — | Ultima mergeata: PR #24 (dettaglio voce ETS + refactor estetico riepilogo rendiconto). Precedenti: PR #22 (lista inline movimenti da classificare), PR #21 (import estratto conto BCC/SumUp + rendiconto ETS), PR #20 (perf audit), PR #19 (cutover Supabase). |
